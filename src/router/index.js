    ...
    children: [
      {
        ...
        meta: { title: "添加文章", icon: "icon-wenzhangguanli", auth: true },
      },
      {
        path: "/blogType",
        name: "BlogType",
    ...
    children: [
      {
        ...
        meta: { title: "项目列表", icon: "icon-wenzhangguanli", auth: true },
      },
      {
        path: "/addProject",
        name: "AddProject",
        component: () => import("@/views/addProject/index"),
        meta: { title: "添加项目", icon: "tree", auth: true },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: "设置", icon: "el-icon-document", auth: true },
      },
    ],
  },
